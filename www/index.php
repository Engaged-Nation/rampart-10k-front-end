...
<head>
    <title>$10K Tuesdays presented by Rampart Casino</title>
...
<body>
    ...
    <script src="//<?php echo $enConfigClient['environment']['site_portal']; ?>/lib/js/engage.php?client_name=rampart-10k&client_id=69455efbdf4bee71ad439735bd2b0ce6" type="text/javascript"></script>
